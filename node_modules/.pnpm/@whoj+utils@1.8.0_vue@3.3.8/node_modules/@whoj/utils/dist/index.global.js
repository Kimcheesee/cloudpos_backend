...
this.Whoj = this.Whoj || {};
this.Whoj.Utils = (function (exports, vueDemi) {
	'use strict';
	...
	const toString$1 = (val) => Object.prototype.toString.call(val);
	const noop = () => {
	};
	...
	const isObject$2 = (val) => toString$1(val) === "[object Object]";
	const isArray$1 = (val) => Array.isArray(val);
	const isWindow = (val) => typeof window !== "undefined" && toString$1(val) === "[object Window]";
	...
	function isObjectMergable(item) {
	  return isObject$2(item) && !Array.isArray(item);
	}
