...
type MaybeReactive<DataT> = ComputedRef<Array<DataT>> | Array<DataT> | Ref<Array<DataT>> | Ref<null> | Ref<null | Array<DataT>>;
...
export { FuseJS, type FuseOptions, type FuseResult, type MaybeReactive, useFuseJs };
